        ...
        $('.input-error').text('');
            ...
            $.ajax({
                ...
                success: function (data) {
                    if (data.success) {
                        $('.cf-msg').html('');
                        $('.cf-msg').fadeIn().html('<div class="alert alert-success"><strong>Sucesso!</strong> ' + data.message + '</div>');
                        setTimeout(function () {
                            $('.cf-msg').fadeOut('slow');
                        }, 5000);
                        ...
                        if (data.message != undefined && data.message != "") {
                            $('.cf-msg').fadeIn().html('<div class="alert alert-danger"><strong>Não foi possível enviar sua mensagem!!</strong> ' + data.message + '</div > ');
